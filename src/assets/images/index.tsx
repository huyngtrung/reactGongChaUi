const images = {
    logo: require('~/assets/images/logo 1.svg').default,
    logoOnly: require('~/assets/images/logoOnly.svg').default,
    more: require('~/assets/images/More.svg').default,
    step1: require('~/assets/images/Step1.svg').default,
    step2: require('~/assets/images/Step2.svg').default,
    step3: require('~/assets/images/Step3.svg').default,
    step4: require('~/assets/images/Step4.svg').default,
